...
{
  "$end", "error", "$undefined", "CHAR_ERR", "KEY", "NUMCONST", "ID",
  "CHARCONST", "CHARCONST_ESC", "RANGE", "STRINGCONST", "BOOLCONST", "OP",
  "INVALID", "ADDASS", "SUBASS", "MULASS", "DIVASS", "DEC", "INC", "NOTEQ",
  "EQ", "LESSEQ", "GRETEQ", "$accept", "program", "decleration", "MULOP", YY_NULLPTR
};
#endif
...
#line 37 "parser.y" /* yacc.c:1646  */
    {printf("Line %d Token: NUMCONST Value: %d  Input: %s\n", (yyvsp[0].Token_Data)->Line_Num, (yyvsp[0].Token_Data)->Num_Val, (yyvsp[0].Token_Data)->Token_Str );}
#line 1254 "parser.tab.c" /* yacc.c:1646  */
    break;

  case 5:
#line 38 "parser.y" /* yacc.c:1646  */
    {printf("Line %d Token: %s\n", (yyvsp[0].Token_Data)->Line_Num, (yyvsp[0].Token_Data)->Token_Str );}
...
#line 40 "parser.y" /* yacc.c:1646  */
    {printf("Line %d Token: STRINGCONST Value: '%s'  Input: %s \n", (yyvsp[0].Token_Data)->Line_Num, (yyvsp[0].Token_Data)->Raw_Str, (yyvsp[0].Token_Data)->Token_Str ); }
...
#line 42 "parser.y" /* yacc.c:1646  */
    {printf("Line %d Token: CHARCONST Value: '%c'  Input: %s\n", (yyvsp[0].Token_Data)->Line_Num, (yyvsp[0].Token_Data)->Token_Str[1], (yyvsp[0].Token_Data)->Token_Str );}
...
#line 44 "parser.y" /* yacc.c:1646  */
    {printf("Line %d Token: CHARCONST Value: '%s'  Input: \'%s\n", (yyvsp[0].Token_Data)->Line_Num, (yyvsp[0].Token_Data)->Token_Str,(yyvsp[0].Token_Data)->Raw_Str+1 );}

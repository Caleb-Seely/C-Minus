...
void initErrorProcessing() {
    ...
    niceTokenNameMap["LIndex"] = (char *)"\'[\'";
    niceTokenNameMap["RIndex"] = (char *)"\']\'";
    niceTokenNameMap["COM"] = (char *)"\',\'";
    niceTokenNameMap["COL"] = (char *)"\':\'";
    niceTokenNameMap["QMARK"] = (char *)"\'?\'";
    ...
    niceTokenNameMap["FALSE"] = (char *)"\"false\"";
...
void yyerror(const char *msg)
{
    ...
    // print components
    printf("ERROR(%d): Syntax error, unexpected %s", LINE_NUMBER, strs[3]);
    if (elaborate(strs[3])) {
